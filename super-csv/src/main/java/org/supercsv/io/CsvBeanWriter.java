...
public class CsvBeanWriter extends AbstractCsvWriter implements ICsvBeanWriter {
    ...
    private void extractBeanValues(final Object source, final String[] nameMapping) {
        ...
        for (int i = 0; i < nameMapping.length; i++) {
            ...
            if (fieldName == null) {
                // assume they always want a blank column
                beanValues.add(null);
            } else {
     ...
     * {@inheritDoc}
     */
    public void write(final Object source, final String[] nameMapping, final CellProcessor[] processors) throws IOException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
