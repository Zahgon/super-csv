...
public class SuperCsvCellProcessorException extends SuperCsvException {
     ...
     */
    public SuperCsvCellProcessorException(final String msg, final CsvContext context, final CellProcessor processor, final Throwable t) {
        super(msg, context, t);
        this.processor = processor;
    }
     ...
     *            the cell processor that was executing
     */
    public SuperCsvCellProcessorException(final Class<?> expectedType, final Object actualValue, final CsvContext context, final CellProcessor processor) {
