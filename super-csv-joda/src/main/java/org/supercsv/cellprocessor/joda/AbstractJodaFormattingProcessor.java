...
public abstract class AbstractJodaFormattingProcessor<T> extends CellProcessorAdaptor {
     ...
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final CellProcessor next) {
        super(next);
        checkPreconditions(jodaClass);
        this.jodaClass = jodaClass;
        this.formatter = null;
     ...
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final DateTimeFormatter formatter) {
     ...
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final DateTimeFormatter formatter, final CellProcessor next) {
        super(next);
        checkPreconditions(jodaClass, formatter);
        this.jodaClass = jodaClass;
        this.formatter = formatter;
     ...
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final String pattern) {
     ...
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final String pattern, final CellProcessor next) {
     ...
     *             if jodaClass or pattern is null
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final String pattern, final Locale locale) {
     ...
     *             if jodaClass, pattern or next is null
     */
    public AbstractJodaFormattingProcessor(final Class<T> jodaClass, final String pattern, final Locale locale, final CellProcessor next) {
        super(next);
        checkPreconditions(jodaClass, pattern);
        this.jodaClass = jodaClass;
        this.pattern = pattern;
     ...
     *             if jodaClass or formatter is null
     */
    private static void checkPreconditions(final Class<?> jodaClass, final DateTimeFormatter formatter) {
        if (jodaClass == null) {
            throw new NullPointerException("jodaClass should not be null");
     ...
     *             if jodaClass or pattern is null
     */
    private static void checkPreconditions(final Class<?> jodaClass, final String pattern) {
        if (jodaClass == null) {
            throw new NullPointerException("jodaClass should not be null");
     ...
     */
    protected abstract String format(final T jodaType, final DateTimeFormatter formatter);
     ...
     *             if the Joda type couldn't be formatted
     */
    protected abstract String format(final T jodaType, final String pattern, final Locale locale);
