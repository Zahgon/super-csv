...
public class FmtDateTime extends AbstractJodaFormattingProcessor<DateTime> {
     ...
     */
    public FmtDateTime(final DateTimeFormatter formatter, final CellProcessor next) {
     ...
     *             if pattern or next is null
     */
    public FmtDateTime(final String pattern, final Locale locale, final CellProcessor next) {
     ...
     */
    @Override
    protected String format(final DateTime jodaType, final DateTimeFormatter formatter) {
     ...
     */
    @Override
    protected String format(final DateTime jodaType, final String pattern, final Locale locale) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
