 ...
 */
public abstract class AbstractJodaParsingProcessor<T> extends CellProcessorAdaptor implements StringCellProcessor {
     ...
     */
    public AbstractJodaParsingProcessor(final DateTimeFormatter formatter, final CellProcessor next) {
        super(next);
        checkPreconditions(formatter);
        this.formatter = formatter;
    }
